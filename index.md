...
## disentanglement
 ...
 - [[pdfs/dl/disentanglement/definition_disentanglement.pdf|definition_disentanglement]]: . [[papers/dl/disentanglement/definition_disentanglement.md|Notes]]
 ...
 - [[pdfs/dl/disentanglement/trauble_on_disentangled_representations_learned_from_correlated_data.pdf|trauble_on_disentangled_representations_learned_from_correlated_data]]: . [[papers/dl/disentanglement/trauble_on_disentangled_representations_learned_from_correlated_data.md|Notes]]
...
## sparse
 - [[pdfs/dl/sparse/controllable_sparse_alternatives_softmax.pdf|controllable_sparse_alternatives_softmax]]: . [[papers/dl/sparse/controllable_sparse_alternatives_softmax.md|Notes]]
 - [[pdfs/dl/sparse/graph_induced_sparsity_gini.pdf|graph_induced_sparsity_gini]]: . [[papers/dl/sparse/graph_induced_sparsity_gini.md|Notes]]
 - [[pdfs/dl/sparse/learning_sparse_distributions.pdf|learning_sparse_distributions]]: . [[papers/dl/sparse/learning_sparse_distributions.md|Notes]]
 - [[pdfs/dl/sparse/lockout_sparse_regularization_neural_networks.pdf|lockout_sparse_regularization_neural_networks]]: . [[papers/dl/sparse/lockout_sparse_regularization_neural_networks.md|Notes]]
 - [[pdfs/dl/sparse/sparse_linear_layers_debuggable_deep_networks.pdf|sparse_linear_layers_debuggable_deep_networks]]: . [[papers/dl/sparse/sparse_linear_layers_debuggable_deep_networks.md|Notes]]
## tabular
...
## transformer
 - [[pdfs/nlp/transformer/gpt3.pdf|gpt3]]: . [[papers/nlp/transformer/gpt3.md|Notes]]
 - [[pdfs/nlp/transformer/transformer_training_tips.pdf|transformer_training_tips]]: . [[papers/nlp/transformer/transformer_training_tips.md|Notes]]
...
## generalization
 ...
 - [[pdfs/rl/generalization/neuro_algorithmic_policies_fast_combinatorial_generalization.pdf|Neuro-algorithmic Policies Enable Fast Combinatorial Generalization.]]: . [[papers/rl/generalization/neuro_algorithmic_policies_fast_combinatorial_generalization.md|Notes]]
 - [[pdfs/rl/generalization/neuroevolution_self_interpretable_agents.pdf|Neuroevolution of self-interpretable agents.]]: Chop the image up into patches and use attention to select the K most important pathces as a form of sparsity. Agents using this information were robust to changes in the observation such as color perturbations, vertical bars in the input and other distractors in the input. Also showed that such an inductive bias can in some cases be harmful, eg, showed that adding a distractor that was similar to the attended object harmed performance. [[papers/rl/generalization/neuroevolution_self_interpretable_agents.md|Notes]]
 - [[pdfs/rl/generalization/schema_networks_zero_shot_transfer_generative_causal_model.pdf|Schema Networks - Zero-shot Transfer with a Generative Causal Model of Intuitive Physics.]]: . [[papers/rl/generalization/schema_networks_zero_shot_transfer_generative_causal_model.md|Notes]]
 - [[pdfs/rl/generalization/sparse_attention_guided_dynamic_value_estimation.pdf|Sparse Attention Guided Dynamic Value Estimation for Single-Task Multi-Scene Reinforcement Learning.]]: . [[papers/rl/generalization/sparse_attention_guided_dynamic_value_estimation.md|Notes]]
...
## grounded_language
 ...
 - [[pdfs/rl/grounded_language/gll_simulated_3d_world.pdf|gll_simulated_3d_world]]: . [[papers/rl/grounded_language/gll_simulated_3d_world.md|Notes]]
 ...
 - [[pdfs/rl/grounded_language/hanjie_emma_grounding_language_to_entities_and_dynamics.pdf|hanjie_emma_grounding_language_to_entities_and_dynamics]]: . [[papers/rl/grounded_language/hanjie_emma_grounding_language_to_entities_and_dynamics.md|Notes]]
 ...
 - [[pdfs/rl/grounded_language/survey_rl_informed_by_natural_language.pdf|survey_rl_informed_by_natural_language]]: . [[papers/rl/grounded_language/survey_rl_informed_by_natural_language.md|Notes]]
...
### generalization
 - [[pdfs/rl/grounded_language/generalization/environmental_drivers_of_systematicity_and_generalization.pdf|Environmental drivers of systematicity and generalization in a situated agent.]]: Studied what kind of environments and training data can assist generalization to unseen tasks. Concludes that having access to many frames of richly varying multi-modal observations can improve systematic generalization. [[papers/rl/grounded_language/generalization/environmental_drivers_of_systematicity_and_generalization.md|Notes]]
 - [[pdfs/rl/grounded_language/generalization/care_multi_task_rl_context_representations.pdf|Multi-Task Reinforcement Learning with Context-based Representations.]]: Mutli-task setting where tasks are encoded as natural language. Uses a model consisting of a mixture of encoders, where encodings are re-weighted and combined according to attention scores. [[papers/rl/grounded_language/generalization/care_multi_task_rl_context_representations.md|Notes]]
 - [[pdfs/rl/grounded_language/generalization/bcz_zero_shot_task_generalization_language.pdf|bcz_zero_shot_task_generalization_language]]: . [[papers/rl/grounded_language/generalization/bcz_zero_shot_task_generalization_language.md|Notes]]
...
### hindsight
 ...
 - [[pdfs/rl/hrl/hindsight/representation_learning_hrl.pdf|representation_learning_hrl]]: . [[papers/rl/hrl/hindsight/representation_learning_hrl.md|Notes]]
...
### representations
 ...
 - [[pdfs/rl/hrl/representations/sectar_hrl_trajectory_autoencoder.pdf|sectar_hrl_trajectory_autoencoder]]: . [[papers/rl/hrl/representations/sectar_hrl_trajectory_autoencoder.md|Notes]]
...
## imitation
 - [[pdfs/rl/imitation/adverarial_imitation_learning.pdf|adverarial_imitation_learning]]: . [[papers/rl/imitation/adverarial_imitation_learning.md|Notes]]
 - [[pdfs/rl/imitation/critic_regularized_regression.pdf|critic_regularized_regression]]: . [[papers/rl/imitation/critic_regularized_regression.md|Notes]]
## inverse_rl
 - [[pdfs/rl/inverse_rl/guided_cost_learning.pdf|guided_cost_learning]]: . [[papers/rl/inverse_rl/guided_cost_learning.md|Notes]]
## learning_algorithms
...
## multitask
 - [[pdfs/rl/multitask/mtan_end_to_end_multi_task_learning_with_attention.pdf|Multi-Task Learning With Attention for End-to-End Autonomous Driving.]]: Task specific channel attention - shared backbone with different channel attention networks per task, which perform a form of feature selection like FiLM (MTAN). [[papers/rl/multitask/mtan_end_to_end_multi_task_learning_with_attention.md|Notes]]
 - [[pdfs/rl/multitask/softmodule_multi_task_rl_with_soft_modularization.pdf|Multi-Task Reinforcement Learning with Soft Modularization.]]: Avoid gradient conflicts by using different modules for different tasks and then learning to route inputs between them (SoftModule). [[papers/rl/multitask/softmodule_multi_task_rl_with_soft_modularization.md|Notes]]
...
## offline
 - [[pdfs/rl/offline/gail_generative_adversarial_imitation_learning.pdf|Robot Manipulation Learning Using Generative Adversarial Imitation Learning.]]: Train a generative distribution for state-visitation that approximates the data distribution. The discriminator must classify if the state-action pairs come from the agent or expert and the generator's job is to fool the discriminator similar to GAN. [[papers/rl/offline/gail_generative_adversarial_imitation_learning.md|Notes]]
 - [[pdfs/rl/offline/conservative_q_learning_offline_rl.pdf|conservative_q_learning_offline_rl]]: . [[papers/rl/offline/conservative_q_learning_offline_rl.md|Notes]]
 ...
 - [[pdfs/rl/offline/offline_reinforcement_learning_tutorial_levine.pdf|offline_reinforcement_learning_tutorial_levine]]: . [[papers/rl/offline/offline_reinforcement_learning_tutorial_levine.md|Notes]]
 - [[pdfs/rl/offline/rce_replacing_rewards_with_examples.pdf|rce_replacing_rewards_with_examples]]: . [[papers/rl/offline/rce_replacing_rewards_with_examples.md|Notes]]
 - [[pdfs/rl/offline/robust_rewards_with_adversarial_inverse_rl.pdf|robust_rewards_with_adversarial_inverse_rl]]: . [[papers/rl/offline/robust_rewards_with_adversarial_inverse_rl.md|Notes]]
 - [[pdfs/rl/offline/sqil_offline_imitation_learning_via_rl_sparse_rewards.pdf|sqil_offline_imitation_learning_via_rl_sparse_rewards]]: . [[papers/rl/offline/sqil_offline_imitation_learning_via_rl_sparse_rewards.md|Notes]]
 - [[pdfs/rl/offline/valuedice_discriminator_actor_critic_offline_imitation_learning.pdf|valuedice_discriminator_actor_critic_offline_imitation_learning]]: . [[papers/rl/offline/valuedice_discriminator_actor_critic_offline_imitation_learning.md|Notes]]
...
### disentanglement
 - [[pdfs/rl/planning/disentanglement/composable_planning_with_attributes_disentanglement.pdf|composable_planning_with_attributes_disentanglement]]: . [[papers/rl/planning/disentanglement/composable_planning_with_attributes_disentanglement.md|Notes]]
### generalization
 - [[pdfs/rl/planning/generalization/procedural_generalization_by_planning_self_supervised_world_models.pdf|Procedural Generalization by Planning with Self-Supervised World Models.]]: Investigates generalization capability of planning, and representation learning via MuZero. Results indicated that observation generalization was possible when planning decoupled from representation learning, but task generalization did not always work. [[papers/rl/planning/generalization/procedural_generalization_by_planning_self_supervised_world_models.md|Notes]]
 - [[pdfs/rl/planning/generalization/trajectory_wise_multiple_choice_learning_for_dynamics_regularization.pdf|Trajectory-wise Multiple Choice Learning for Dynamics Generalization in Reinforcement Learning.]]: . [[papers/rl/planning/generalization/trajectory_wise_multiple_choice_learning_for_dynamics_regularization.md|Notes]]
### probabilistic
...
## relational
 ...
 - [[pdfs/rl/relational/relational_deep_rl.pdf|relational_deep_rl]]: . [[papers/rl/relational/relational_deep_rl.md|Notes]]
## representations
